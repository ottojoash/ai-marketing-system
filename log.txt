...
MongoDB (for data storage) -Pyhton (for AI )
...
Usage
Login: Enter your credentials to log into the application.
Dashboard: Once logged in, you will be redirected to the dashboard, where you can see an overview of key metrics.
Reports: Navigate to the "Reports" section to view detailed reports such as new likes, comments, and customer feedback.
Analytics: Check out the analytics section to dive deeper into the performance metrics.
Settings: Customize your settings, strategy, and other configurations from the settings page.
Folder Structure
